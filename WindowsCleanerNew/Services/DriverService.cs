...
namespace WindowsCleaner.Services
{
    ...
    public class DriverService
    {
        ...
        public async Task<List<DriverInfo>> GetAvailableDriversAsync()
        {
            // Get all installed drivers and check which ones have updates available
            var allDrivers = await GetSystemDriversAsync();
            ...
            foreach (var driver in allDrivers)
            {
                ...
                {
                    // Skip drivers that can't be checked
                }
            }
